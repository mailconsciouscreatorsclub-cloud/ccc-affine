...
import type { VoiceFeedbackConfig } from '../../types';
import {
...
describe('VoiceFeedbackService', () => {
  ...
  beforeEach(async () => {
    ...
    service = provider.get(VoiceFeedbackService);
  ...
  describe('initialization', () => {
    it('should initialize successfully with default config', async () => {
      ...
      const newService = testProvider.get(VoiceFeedbackService);
  ...
  describe('browser compatibility', () => {
    ...
    it('should handle missing speechSynthesis API', async () => {
      ...
      configureVoiceControlModule(testFramework);
      const testProvider = testFramework.provider();
      const compatService = testProvider.get(VoiceFeedbackService);
    ...
    it('should work in SSR environment', async () => {
      ...
      configureVoiceControlModule(testFramework);
      const testProvider = testFramework.provider();
      const ssrService = testProvider.get(VoiceFeedbackService);
