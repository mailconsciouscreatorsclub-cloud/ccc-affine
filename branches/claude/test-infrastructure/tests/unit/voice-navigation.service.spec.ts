...
import type { VoiceNavigationContext } from '../../../../packages/frontend/core/src/modules/voice-control/types';
...
describe('VoiceNavigationService', () => {
  ...
  describe('initialization', () => {
    it('should initialize successfully', async () => {
      const newService = new VoiceNavigationService();
    ...
    it('should handle SSR environment safely', async () => {
      ...
      const ssrService = new VoiceNavigationService();
  ...
  describe('browser safety', () => {
    it('should handle missing window object', async () => {
      ...
      const safeService = new VoiceNavigationService();
    ...
    it('should work in iframe environments', async () => {
      ...
      const iframeService = new VoiceNavigationService();
